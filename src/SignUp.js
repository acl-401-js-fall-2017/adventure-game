...
export default class SignUp extends Component{
  ...
  render() {
    const { playerOneName, playerTwoName, playerOneDog, playerOneImg, playerTwoImg } = this.state;
    return (
      <SignUpWrapper shouldDisplay ={this.props.shouldDisplay}>
        <div style={{ width: '80%' }}>
          <div style={{ display: 'flex', flexDirection: 'column' }} >
            <span>In the left Corner:</span>
            <img style={{ width: '40%' }} alt={'avatar'} src={playerOneImg}/>
            <div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', width: '100%', marginTop:'20%' }} >
          ...
          <div style={{ display: 'flex', justifyContent: 'center' }}>
            <StyledP className="button" onClick={() =>{
        ...
        <div style={{ display:'flex', flexDirection: 'column', width: '80%' }}>
          ...
          <img style={{ width: '40%' }} alt={'avatar'} src={playerTwoImg}/>
